...
<html lang="en">
  <head>
    ...
    <script>
        ...
        document.getElementById('time').innerHTML=time+"<br>Day and Date is: "+date;
        }, 1000);
    </script>
  </head>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <div class="container my-4">
        <div class="jumbotron">
            ...
            <p class="lead">This is current time.</p>
            <hr class="my-4">
            <p>Its live local time.</p>
            <p class="lead">
              <a class="btn btn-primary btn-lg" href="#" role="button">dont click</a>
            </p>
          </div>
    </div>
